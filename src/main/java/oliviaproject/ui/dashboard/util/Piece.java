...
TourWLittleRock(Side.White,new PositionTour(),"\u2656", COLOR_WHITE,COLOR_WHITE_OUTLINE),
...
TourBLittleRock(Side.Black,new PositionTour(),"\u2656", COLOR_BLACK,COLOR_BLACK_OUTLINE),
...
Piece(Side side, Position position,String unicode, Color color,Color colorOutline) {
	...
	img=ChessBoardPieceImage.addColoredUnicodeCharToBufferedImage(unicode,     color,
    		colorOutline,
            blackSquare);
}
