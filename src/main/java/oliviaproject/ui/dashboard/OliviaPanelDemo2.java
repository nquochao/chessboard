...
import oliviaproject.ui.selection.tile.color.demo.KeyboardDemo2;
import oliviaproject.ui.selection.tile.color.demo.MoveObject;

public class OliviaPanelDemo2 extends OliviaPanel implements IChessboardPanel, EventListener {
	/**
	 * 
	 */
...
protected void moveObject(Graphics2D g2d, MoveObject moveObject) {
    ...
    Font font = moveObject.getFont();
       GlyphVector gv = font.createGlyphVector( frc, moveObject.getLabel());
        ...
        int xOff = moveObject.getX();
        int yOff = moveObject.getY();
